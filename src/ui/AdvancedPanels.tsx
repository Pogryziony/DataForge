...
export function ImportPanel({ run, busy, onPool, pools }: { run(action: WorkerAction): void; busy: boolean; onPool(pool: ReferencePool): void; pools: ReferencePool[] }) {
  const t = useText();
